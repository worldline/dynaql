...
public class ClientBuilderTest {
    ...
    public void testTimeout() {
        ...
        Assertions.assertEquals(builder.getConnectTimeout().getValue(), 5);
        Assertions.assertEquals(builder.getConnectTimeout().getTimeUnit(), TimeUnit.SECONDS);

        Assertions.assertEquals(builder.getReadTimeout().getValue(), 500);
        Assertions.assertEquals(builder.getReadTimeout().getTimeUnit(), TimeUnit.MILLISECONDS);
